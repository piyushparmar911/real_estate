<?php $__env->startSection('title', 'Luxury Family Home - FindHouse'); ?>
        ...
        <div class="row m0">
          <div class="col-lg-12 p0">
            <div class="spls_style_one pr1 1px">
              <img class="img-fluid w100" src="<?php echo e(asset('images/property/ls1.jpg')); ?>" alt="ls1.jpg">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row m0">
          <div class="col-sm-6 col-lg-6 p0">
            <div class="spls_style_one">
              <a class="popup-img" href="<?php echo e(asset('images/property/ls2.jpg')); ?>"><img class="img-fluid w100" src="<?php echo e(asset('images/property/ls2.jpg')); ?>" alt="ls2.jpg"></a>
            </div>
          </div>
          <div class="col-sm-6 col-lg-6 p0">
            <div class="spls_style_one">
              <a class="popup-img" href="<?php echo e(asset('images/property/ls3.jpg')); ?>"><img class="img-fluid w100" src="<?php echo e(asset('images/property/ls3.jpg')); ?>" alt="ls3.jpg"></a>
            </div>
          </div>
          <div class="col-sm-6 col-lg-6 p0">
            <div class="spls_style_one">
              <a class="popup-img" href="<?php echo e(asset('images/property/ls4.jpg')); ?>"><img class="img-fluid w100" src="<?php echo e(asset('images/property/ls4.jpg')); ?>" alt="ls4.jpg"></a>
            </div>
          </div>
          <div class="col-sm-6 col-lg-6 p0">
            <div class="spls_style_one">
              <a class="popup-img" href="<?php echo e(asset('images/property/ls5.jpg')); ?>"><img class="img-fluid w100" src="<?php echo e(asset('images/property/ls5.jpg')); ?>" alt="ls5.jpg"></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row listing_single_row">
      <div class="col-sm-6 col-lg-7 col-xl-8">
        <div class="single_property_title">
          <a href="<?php echo e(asset('images/property/ls1.jpg')); ?>" class="upload_btn popup-img"><span class="flaticon-photo-camera"></span> View Photos</a>
        </div>
      </div>
              ...
              <div class="property_video p0">
                <div class="thumb">
                  ...
                  <div class="overlay_icon">
                    <a href="#"><img class="map_img_icon" src="<?php echo e(asset('images/header-logo.png')); ?>" alt="header-logo.png"></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="sidebar_advanced_search_widget">
            ...
            <div class="agent_single_grid_view">
              <div class="aso_agent_content_details">
                <div class="media">
                  <img class="img-fluid" src="<?php echo e(asset('images/team/1.jpg')); ?>" alt="1.jpg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\msc-it sem1\real estate project\real_estate\resources\views/listing-single-v2.blade.php ENDPATH**/ ?>