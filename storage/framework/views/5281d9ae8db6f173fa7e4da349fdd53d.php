<?php $__env->startSection('title', 'Home - FindHouse'); ?>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl">
          <div class="properti_city">
            <div class="thumb"><img class="img-fluid w100" src="<?php echo e(asset('images/property/pc7.jpg')); ?>" alt="pc7.jpg"></div>
            <div class="overlay">
              <div class="details">
                <h4>Miami</h4>
                <p>24 Properties</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl">
          <div class="properti_city">
            <div class="thumb"><img class="img-fluid w100" src="<?php echo e(asset('images/property/pc8.jpg')); ?>" alt="pc8.jpg"></div>
            <div class="overlay">
              <div class="details">
                <h4>Los Angeles</h4>
                <p>18 Properties</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl">
          <div class="properti_city">
            <div class="thumb"><img class="img-fluid w100" src="<?php echo e(asset('images/property/pc9.jpg')); ?>" alt="pc9.jpg"></div>
            <div class="overlay">
              <div class="details">
                <h4>New York</h4>
                <p>89 Properties</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl">
          <div class="properti_city">
            <div class="thumb"><img class="img-fluid w100" src="<?php echo e(asset('images/property/pc10.jpg')); ?>" alt="pc10.jpg"></div>
            <div class="overlay">
              <div class="details">
                <h4>Florida</h4>
                <p>47 Properties</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl">
          <div class="properti_city">
            <div class="thumb"><img class="img-fluid w100" src="<?php echo e(asset('images/property/pc11.jpg')); ?>" alt="pc11.jpg"></div>
            <div class="overlay">
              <div class="details">
                <h4>Orlando</h4>
                <p>89 Properties</p>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="feat_property home3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo e(asset('images/property/fp4.jpg')); ?>" alt="fp4.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">For Rent</a></li>
                  <li class="list-inline-item dn"></li>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-4 col-xl-2">
          <div class="our_agent">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo e(asset('images/team/5.jpg')); ?>" alt="5.jpg">
              <div class="overylay">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\msc-it sem1\real estate project\real_estate\resources\views/index3.blade.php ENDPATH**/ ?>