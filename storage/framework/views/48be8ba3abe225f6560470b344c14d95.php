<?php $__env->startSection('title', 'Login - FindHouse'); ?>
...
<form action="#" method="POST">
  ...
  <div class="text-center mt-4">
    <p>Don't have an account? <a href="<?php echo e(url('/register')); ?>" class="text-thm">Create Account</a></p>
  </div>
</form>
...
<?php echo $__env->make('layouts.header-only', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\msc-it sem1\real estate project\real_estate\resources\views/page-login.blade.php ENDPATH**/ ?>