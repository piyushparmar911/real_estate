            ...
            <div class="col-lg-6 col-xl-6">
              <div class="login_form">
                <form action="#">
                  ...
                  <p class="text-center">Don't have an account? <a class="text-thm" href="#" onclick="$('#profile-tab').tab('show')">Register</a></p>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 col-xl-6">
              <div class="sign_up_form">
                ...
                <form action="#">
                  ...
                  <p class="text-center">Already have an account? <a class="text-thm" href="#" onclick="$('#home-tab').tab('show')">Log In</a></p>
                </form>
              </div>
            </div>
          </div>
